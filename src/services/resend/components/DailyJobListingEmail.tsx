              ...
              >
                ...
                <div className="mb-5">
                  {getBadges(jobListing).map((badge, index) => (
                    <div
                      key={index}
                      className="inline-block rounded-md border border-solid font-medium w-fit text-foreground text-sm px-3 py-1 mb-1 mr-1"
                    >
                      {badge}
                    </div>
                  ))}
...
function getBadges(jobListing: JobListing) {
  ...
  if (jobListing.wage != null && jobListing.wageInterval) {
