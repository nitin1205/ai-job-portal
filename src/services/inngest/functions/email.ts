...
import DailyApplicationEmail from "@/services/resend/components/DailyApplicationEmai";
...
export const prepareDailyOrganizationUserApplicationNotifications =
  inngest.createFunction(
    ...
    async ({ step, event }) => {
      ...
      const getApplications = step.run("get-recent-application", async () => {
...
export const sendDailyOrganizationUserApplication = inngest.createFunction(
  {
